...
let _t = (r = 21) => crypto.getRandomValues(new Uint8Array(r)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), "");
var Xe = /* @__PURE__ */ ((r) => (r.VERBOSE = "VERBOSE", r.INFO = "INFO", r.WARN = "WARN", r.ERROR = "ERROR", r))(Xe || {});
const E = {
  BACKSPACE: 8,
  TAB: 9,
  ENTER: 13,
...
const L = me.bind(window, !1), V = me.bind(window, !0);
function oe(r) {
...
function Ce(r, e, t = void 0) {
  ...
  return function() {
    ...
    !a && t.leading === !1 && (a = c);
    const h = e - (c - a);
    return o = this, i = arguments, h <= 0 || h > e ? (s && (clearTimeout(s), s = null), a = c, n = r.apply(o, i), s || (o = i = null)) : !s && t.trailing !== !1 && (s = setTimeout(l, h)), n;
  };
}
function Ht() {
  const r = {
...
const qe = 650;
function te() {
  return window.matchMedia(`(max-width: ${qe}px)`).matches;
}
const Ue = typeof window < "u" && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || window.navigator.platform === "MacIntel" && window.navigator.maxTouchPoints > 1);
function Wt(r, e) {
...
class d {
  ...
  static findAllInputs(e) {
    return Ze(e.querySelectorAll(d.allInputsSelector)).reduce((t, o) => d.isNativeInput(o) || d.containsOnlyInlineElements(o) ? [...t, o] : [...t, ...d.getDeepestBlockElements(o)], []);
  }
  /**
  ...
  static isNodeEmpty(e) {
    let t;
    return this.isSingleTag(e) && !this.isLineBreakTag(e) ? !1 : (this.isElement(e) && this.isNativeInput(e) ? t = e.value : t = e.textContent.replace("​", ""), t.length === 0);
  }
  /**
...
class v {
  ...
  static get isAtEditor() {
    return this.isSelectionAtEditor(v.get());
  }
  /**
  ...
  static isSelectionAtEditor(e) {
    ...
    let o = null;
    return t && t instanceof Element && (o = t.closest(`.${v.CSS.editorZone}`)), o ? o.nodeType === Node.ELEMENT_NODE : !1;
  }
  /**
   ...
   */
  setFakeBackground() {
    document.execCommand(this.commandBackground, !1, "#d4ecff"), this.isFakeBackgroundEnabled = !0;
  }
  /**
...
const Me = "redactor dom changed", et = "block changed", tt = "fake cursor is about to be toggled", ot = "fake cursor have been set";
function $e(r, e) {
...
class F extends we {
  ...
  constructor({
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      let u;
      c || h ? u = !0 : u = !(l.length > 0 && l.every((k) => {
        const { addedNodes: p, removedNodes: m, target: N } = k;
        return [
          ...Array.from(p),
          ...Array.from(m),
          N
  ...
  set selected(e) {
    ...
    const t = e === !0 && v.isRangeInsideContainer(this.holder), o = e === !1 && v.isFakeCursorInsideContainer(this.holder);
    (t || o) && ((i = this.editorEventBus) == null || i.emit(tt, { state: e }), t ? v.addFakeCursor() : v.removeFakeCursor(this.holder), (n = this.editorEventBus) == null || n.emit(ot, { state: e }));
  }
  /**
   ...
   */
  updateCurrentInput() {
    this.currentInput = d.isNativeInput(document.activeElement) || !v.anchorNode ? document.activeElement : v.anchorNode;
  }
  /**
   * Allows to say Editor that Block was changed. Used to manually trigger Editor's 'onChange' callback
   * Can be useful for block changes invisible for editor core.
  ...
  async getActiveToolboxEntry() {
    ...
    return e.find((i) => Object.entries(i.data).some(([n, s]) => t[n] && Wt(t[n], s)));
  }
  /**
...
class Jt extends C {
  constructor() {
    super(...arguments), this.insert = (e = this.config.defaultBlock, t = {}, o = {}, i, n, s, a) => {
      ...
      const c = ((u = a == null ? void 0 : a.conversionConfig) == null ? void 0 : u.export) !== void 0, h = ((f = l.conversionConfig) == null ? void 0 : f.import) !== void 0;
      if (c && h)
        i.convert(s, t, o);
      else {
        const k = [
        ...
        throw new Error(`Conversion from "${s.name}" to "${t}" is not possible. ${k} tool(s) should provide a "conversionConfig"`);
      }
  ...
  get methods() {
    return {
      ...
      unSelectBLockByIndex: (e) => this.unSelectBLockByIndex(e),
      setCurrentBlockIndex: (e) => this.setCurrentBlockIndex(e),
      setUnfocusCallback: (e) => this.setUnfocusCallback(e),
      callUnfocusCallback: () => this.callUnfocusCallback(),
   ...
   * @returns {number}
   */
  setCurrentBlockIndex(e) {
    this.Editor.BlockManager.currentBlockIndex = e;
  }
  /**
   ...
   * @returns {number}
   */
  setUnfocusCallback(e) {
    this.Editor.BlockManager.unfocusCallback = e;
  }
  /**
  ...
  getById(e) {
    const t = this.Editor.BlockManager.getBlockById(e);
    return t === void 0 ? (V("There is no block with id `" + e + "`", "warn"), null) : new ee(t);
  }
  /**
          ...
          return this.map(function(s) {
            var a = function(l, c) {
              ...
              if (c && typeof btoa == "function") {
                var f = (p = u, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(p)))) + " */"), k = u.sources.map(function(m) {
                  return "/*# sourceURL=" + u.sourceRoot + m + " */";
                });
                return [h].concat(k).concat([f]).join(`
`);
              }
              var p;
              return [h].join(`
`);
      ...
      function m(b, g) {
        for (var B = [], T = {}, _ = 0; _ < b.length; _++) {
          var S = b[_], H = g.base ? S[0] + g.base : S[0], M = { css: S[1], media: S[2], sourceMap: S[3] };
          T[H] ? T[H].parts.push(M) : B.push(T[H] = { id: H, parts: [M] });
        }
        return B;
      }
      function N(b, g) {
...
`);
      ...
      function O(b) {
        ...
        return b.attrs.type === void 0 && (b.attrs.type = "text/css"), y(g, b.attrs), N(b, g), g;
      }
      function y(b, g) {
      ...
      function x(b, g) {
        ...
        if (g.singleton) {
          var H = u++;
          B = h || (h = O(g)), T = R.bind(null, B, H, !1), _ = R.bind(null, B, H, !0);
        } else
          b.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (B = function(M) {
            ...
            return M.attrs.type === void 0 && (M.attrs.type = "text/css"), M.attrs.rel = "stylesheet", y(W, M.attrs), N(M, W), W;
          }(g), T = (function(M, W, ce) {
            var Q = ce.css, Be = ce.sourceMap, It = W.convertToAbsoluteUrls === void 0 && Be;
            (W.convertToAbsoluteUrls || It) && (Q = k(Q)), Be && (Q += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(Be)))) + " */");
            var Mt = new Blob([Q], { type: "text/css" }), He = M.href;
            M.href = URL.createObjectURL(Mt), He && URL.revokeObjectURL(He);
          }).bind(null, B, g), _ = function() {
            A(B), B.href && URL.revokeObjectURL(B.href);
          }) : (B = O(g), T = (function(M, W) {
      ...
      t.exports = function(b, g) {
        ...
        return p(B, g), function(T) {
          for (var _ = [], S = 0; S < B.length; S++) {
            var H = B[S];
            (M = a[H.id]).refs--, _.push(M);
          }
          for (T && p(m(T, g), g), S = 0; S < _.length; S++) {
            var M;
            if ((M = _[S]).refs === 0) {
...
`);
      ...
      function R(b, g, B, T) {
        ...
        if (b.styleSheet)
          ...
          var S = document.createTextNode(_), H = b.childNodes;
      ...
      t.exports = function(i) {
        ...
        return i.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(l, c) {
          var h, u = c.trim().replace(/^"(.*)"$/, function(f, k) {
            return k;
          }).replace(/^'(.*)'$/, function(f, k) {
            return k;
          });
          return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(u) ? l : (h = u.indexOf("//") === 0 ? u : u.indexOf("/") === 0 ? s + u : a + u.replace(/^\.\//, ""), "url(" + JSON.stringify(h) + ")");
        });
      };
    }, function(t, o, i) {
      var n, s, a, l, c, h, u, f, k;
      t.exports = (n = "cdx-notifies", s = "cdx-notify", a = "cdx-notify__cross", l = "cdx-notify__button--confirm", c = "cdx-notify__button--cancel", h = "cdx-notify__input", u = "cdx-notify__button", f = "cdx-notify__btns-wrapper", { alert: k = function(p) {
        var m = document.createElement("DIV"), N = document.createElement("DIV"), A = p.message, O = p.style;
        return m.classList.add(s), O && m.classList.add(s + "--" + O), m.innerHTML = A, N.classList.add(a), N.addEventListener("click", m.remove.bind(m)), m.appendChild(N), m;
      }, confirm: function(p) {
        var m = k(p), N = document.createElement("div"), A = document.createElement("button"), O = document.createElement("button"), y = m.querySelector("." + a), x = p.cancelHandler, w = p.okHandler;
        return N.classList.add(f), A.innerHTML = p.okText || "Confirm", O.innerHTML = p.cancelText || "Cancel", A.classList.add(u), O.classList.add(u), A.classList.add(l), O.classList.add(c), x && typeof x == "function" && (O.addEventListener("click", x), y.addEventListener("click", x)), w && typeof w == "function" && A.addEventListener("click", w), A.addEventListener("click", m.remove.bind(m)), O.addEventListener("click", m.remove.bind(m)), N.appendChild(A), N.appendChild(O), m.appendChild(N), m;
      }, prompt: function(p) {
        var m = k(p), N = document.createElement("div"), A = document.createElement("button"), O = document.createElement("input"), y = m.querySelector("." + a), x = p.cancelHandler, w = p.okHandler;
        return N.classList.add(f), A.innerHTML = p.okText || "Ok", A.classList.add(u), A.classList.add(l), O.classList.add(h), p.placeholder && O.setAttribute("placeholder", p.placeholder), p.default && (O.value = p.default), p.inputType && (O.type = p.inputType), x && typeof x == "function" && y.addEventListener("click", x), w && typeof w == "function" && A.addEventListener("click", function() {
          w(O.value);
        }), A.addEventListener("click", m.remove.bind(m)), N.appendChild(O), N.appendChild(A), m.appendChild(N), m;
      }, getWrapper: function() {
...
(function(r, e) {
  (function(t, o) {
    ...
    function t(u) {
      var f = u.tags, k = Object.keys(f), p = k.map(function(m) {
        return typeof f[m];
      }).every(function(m) {
    ...
    t.prototype.clean = function(u) {
      ...
      if (p)
        do {
          ...
          var m = s(p), N;
          m && (N = Array.prototype.some.call(p.childNodes, i));
          var A = !!f.parentNode, O = i(f) && i(p) && A, y = p.nodeName.toLowerCase(), x = l(this.config, y, p), w = m && N;
          ...
          for (var I = 0; I < p.attributes.length; I += 1) {
            ...
            h(R, x, p) && (p.removeAttribute(R.name), I = I - 1);
          }
          this._sanitize(u, p);
    ...
    function l(u, f, k) {
      return typeof u.tags[f] == "function" ? u.tags[f](k) : u.tags[f];
    }
    function c(u, f) {
    ...
    function h(u, f, k) {
      ...
      return f === !0 ? !1 : typeof f[p] == "function" ? !f[p](u.value, k) : typeof f[p] > "u" || f[p] === !1 ? !0 : typeof f[p] == "string" ? f[p] !== u.value : !1;
    }
    return t;
  });
})(nt);
var co = nt.exports;
const ho = /* @__PURE__ */ be(co);
function st(r, e) {
  return r.map((t) => {
    const o = D(e) ? e(t.tool) : e;
    return X(o) || (t.data = Ae(t.data, o)), t;
  });
}
function q(r, e = {}) {
  const t = {
...
function Ae(r, e) {
  return Array.isArray(r) ? uo(r, e) : z(r) ? po(r, e) : J(r) ? fo(r, e) : r;
}
function uo(r, e) {
  return r.map((t) => Ae(t, e));
}
function po(r, e) {
  const t = {};
  for (const o in r) {
    if (!Object.prototype.hasOwnProperty.call(r, o))
      continue;
    const i = r[o], n = go(e[o]) ? e[o] : e;
    t[o] = Ae(i, n);
  }
  return t;
}
function fo(r, e) {
  return z(e) ? q(r, e) : e === !1 ? q(r, {}) : r;
}
function go(r) {
  return z(r) || Nt(r) || D(r);
}
...
class mo extends C {
   ...
   */
  save() {
    return this.Editor.ReadOnly.isEnabled, this.Editor.Saver.save();
  }
}
class ko extends C {
  /**
   ...
   */
  findParentTag(e, t) {
    return new v().findParentTag(e, t);
  }
  /**
...
function at(r, e) {
  ...
  return Object.entries(r).forEach(([o, i]) => {
    if (z(i)) {
      const n = e ? `${e}.${o}` : o;
      Object.values(i).every((a) => J(a)) ? t[o] = n : t[o] = at(i, n);
      return;
    }
    t[o] = i;
  }), t;
...
const ct = class he {
  ...
  leafNodesAndReturnIndex(e) {
    if (this.items.length === 0)
      return this.cursor;
    let t = this.cursor;
    return t === -1 ? t = e === he.directions.RIGHT ? -1 : 0 : this.items[t].classList.remove(this.focusedCssClass), e === he.directions.RIGHT ? t = (t + 1) % this.items.length : t = (this.items.length + t - 1) % this.items.length, d.canSetCaret(this.items[t]) && se(() => v.setCursor(this.items[t]), 50)(), this.items[t].classList.add(this.focusedCssClass), t;
  }
};
ct.directions = {
  RIGHT: "right",
...
class pe {
  ...
  constructor({ items: e, onSearch: t, placeholder: o }) {
    this.listeners = new _e(), this.items = e, this.onSearch = t, this.render(o);
  }
  /**
...
const dt = class ue {
   ...
   */
  lock() {
    Ue ? this.lockHard() : document.body.classList.add(ue.CSS.scrollLocked);
  }
  /**
   * Unlocks body element scroll
   */
  unlock() {
    Ue ? this.unlockHard() : document.body.classList.remove(ue.CSS.scrollLocked);
  }
  /**
...
let Lo = dt;
var Ao = Object.defineProperty, No = Object.getOwnPropertyDescriptor, Ro = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? No(e, t) : e, n = r.length - 1, s; n >= 0; n--)
    (s = r[n]) && (i = (o ? s(e, t, i) : s(i)) || i);
  return o && i && Ao(e, t, i), i;
}, ge = /* @__PURE__ */ ((r) => (r.Close = "close", r))(ge || {});
const ht = class j extends we {
  /**
   ...
   */
  constructor(e) {
    super(), this.scopeElement = document.body, this.listeners = new _e(), this.scrollLocker = new Lo(), this.nodes = {
      wrapper: null,
      popover: null,
...
Ro([
  le
], ht.prototype, "height", 1);
let ut = ht;
class Do extends C {
  constructor() {
    super(...arguments), this.opened = !1, this.selection = new v(), this.onPopoverClose = () => {
      this.close();
    };
  }
  /**
  ...
  open(e = this.Editor.BlockManager.currentBlock) {
    ...
    this.eventsDispatcher.emit(this.events.opened), this.popover = new ut({
      searchable: !0,
      ...
      messages: {
        nothingFound: Y.ui(K.ui.popover, "Nothing found"),
        search: Y.ui(K.ui.popover, "Filter")
      }
...
class $ extends C {
   ...
   */
  make() {
    return this.nodes.wrapper = d.make("div", [
      $.CSS.conversionToolbarWrapper,
      ...this.isRtl ? [this.Editor.UI.CSS.editorRtlFix] : []
    ]), this.nodes.tools = d.make("div", $.CSS.conversionToolbarTools), d.make("div", $.CSS.conversionToolbarLabel, {
      textContent: Y.ui(K.ui.inlineToolbar.converter, "Convert to")
    }), this.addTools(), this.enableFlipper(), d.append(this.nodes.wrapper, this.nodes.tools), this.nodes.wrapper;
  }
  /**
  ...
  open() {
    this.filterTools(), this.opened = !0, this.nodes.wrapper.classList.add($.CSS.conversionToolbarShowed), window.requestAnimationFrame(() => {
      this.flipper.activate(this.tools.map((e) => e.button).filter((e) => !e.classList.contains($.CSS.conversionToolHidden))), this.flipper.focusFirst(), D(this.togglingCallback) && this.togglingCallback(!0);
    });
  }
  /**
   ...
   */
  close() {
    this.opened = !1, this.flipper.deactivate(), this.nodes.wrapper.classList.remove($.CSS.conversionToolbarShowed), D(this.togglingCallback) && this.togglingCallback(!1);
  }
  /**
  ...
  addTool(e, t) {
    var a;
    const o = d.make("div", [$.CSS.conversionTool]), i = d.make("div", [$.CSS.conversionToolIcon]), n = d.make("span");
    n.innerHTML = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`, o.dataset.tool = e, i.innerHTML = t.icon, d.append(o, [i, n]), d.append(o, d.text(Y.t(K.toolNames, t.title || re(e))));
    const s = (a = this.Editor.Tools.blockTools.get(e)) == null ? void 0 : a.shortcut;
    if (s) {
      const l = d.make("span", $.CSS.conversionToolSecondaryLabel, {
        innerText: Oe(s)
      });
      d.append(o, l);
    }
  ...
  async filterTools() {
    ...
    this.tools.forEach((i) => {
      if (t) {
        ...
        i.button.classList.remove($.CSS.conversionToolSelect), n && i.button.classList.add($.CSS.conversionToolSelect);
      }
      i.button.hidden = !1;
    });
  }
        ...
        return s(l, null, [{ key: "supportedCommands", get: function() {
          ...
          for (var h = 0; h < c.length; h++) {
            ...
            for (var f in l.supportedCommands)
              if (l.supportedCommands[f].includes(c[h])) {
                u = this.commands[f] = !0;
                break;
              }
            u || (this.keys[c[h]] = !0);
          ...
          var h, u = { CMD: c.ctrlKey || c.metaKey, SHIFT: c.shiftKey, ALT: c.altKey }, f = !0;
          for (h in this.commands)
            this.commands[h] !== u[h] && (f = !1);
          var k, p = !0;
          for (k in this.keys)
...
const ae = new Ho();
var jo = Object.defineProperty, zo = Object.getOwnPropertyDescriptor, ft = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? zo(e, t) : e, n = r.length - 1, s; n >= 0; n--)
    (s = r[n]) && (i = (o ? s(e, t, i) : s(i)) || i);
  return o && i && jo(e, t, i), i;
}, ke = /* @__PURE__ */ ((r) => (r.Opened = "toolbox-opened", r.Closed = "toolbox-closed", r.BlockAdded = "toolbox-block-added", r))(ke || {});
const Re = class gt extends we {
  /**
   * Toolbox constructor
   *
  ...
  get toolboxItemsToBeDisplayed() {
    const e = (t, o) => ({
      icon: t.icon,
      title: Y.t(K.toolNames, t.title || re(o.name)),
      name: o.name,
      onActivate: () => {
        this.toolButtonActivated(o.name, t.data);
      },
      description: t.description,
      secondaryLabel: o.shortcut ? Oe(o.shortcut) : ""
    });
  ...
  async insertNewBlock(e, t) {
    ...
    a.call(Z.APPEND_CALLBACK), this.api.caret.setToBlock(n), this.emit("toolbox-block-added", {
      block: a
...
class $o extends C {
   ...
   */
  make() {
    this.nodes.wrapper = d.make("div", this.CSS.toolbar), ["content", "actions"].forEach((o) => {
      this.nodes[o] = d.make("div", this.CSS[o]);
    ...
    const e = d.make("div");
    e.appendChild(document.createTextNode(Y.ui(K.ui.toolbar.toolbox, "Add"))), e.appendChild(d.make("div", this.CSS.plusButtonShortcut, {
      textContent: "⇥ Tab"
    ...
    t.innerHTML = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      </svg>`, d.append(this.nodes.settingsToggler, t), d.append(this.nodes.actions, this.nodes.settingsToggler), this.tooltip.onHover(
      this.nodes.settingsToggler,
      Y.ui(K.ui.blockTunes.toggler, "Click to tune"),
      {
        hidingDelay: 400
      }
   ...
   */
  makeToolbox() {
    return this.toolboxInstance = new Uo({
      api: this.Editor.API.methods,
      tools: this.Editor.Tools.blockTools,
      i18nLabels: {
        filter: Y.ui(K.ui.popover, "Filter"),
        nothingFound: Y.ui(K.ui.popover, "Nothing found")
      }
...
var ye = /* @__PURE__ */ ((r) => (r[r.Block = 0] = "Block", r[r.Inline = 1] = "Inline", r[r.Tune = 2] = "Tune", r))(ye || {}), ve = /* @__PURE__ */ ((r) => (r.Shortcut = "shortcut", r.Toolbox = "toolbox", r.EnabledInlineTools = "inlineToolbar", r.EnabledBlockTunes = "tunes", r.Config = "config", r))(ve || {}), mt = /* @__PURE__ */ ((r) => (r.Shortcut = "shortcut", r.SanitizeConfig = "sanitize", r))(mt || {}), ne = /* @__PURE__ */ ((r) => (r.IsEnabledLineBreaks = "enableLineBreaks", r.Toolbox = "toolbox", r.ConversionConfig = "conversionConfig", r.IsReadOnlySupported = "isReadOnlySupported", r.PasteConfig = "pasteConfig", r))(ne || {}), De = /* @__PURE__ */ ((r) => (r.IsInline = "isInline", r.Title = "title", r))(De || {}), kt = /* @__PURE__ */ ((r) => (r.IsTune = "isTune", r))(kt || {});
class Pe {
  /**
   * @class
...
class Wo extends C {
   ...
   */
  move() {
    const e = v.rect, t = this.Editor.UI.nodes.wrapper.getBoundingClientRect(), o = {
      x: e.x - t.left,
   ...
   */
  allowedToShow() {
    const e = ["IMG", "INPUT"], t = v.get(), o = v.text;
  ...
  addConversionToggler() {
    this.nodes.conversionToggler = d.make("div", this.CSS.conversionToggler), this.nodes.conversionTogglerContent = d.make("div", this.CSS.conversionTogglerContent), this.nodes.conversionTogglerIcon = d.make("div", this.CSS.conversionTogglerIcon), this.nodes.conversionTogglerText = d.make("div", this.CSS.conversionTogglerText);
    const e = d.make("div", this.CSS.conversionTogglerArrow, {
      innerHTML: lt
    });
    this.nodes.conversionTogglerContent.appendChild(this.nodes.conversionTogglerIcon), this.nodes.conversionTogglerContent.appendChild(this.nodes.conversionTogglerText), this.nodes.conversionToggler.appendChild(this.nodes.conversionTogglerContent), this.nodes.conversionToggler.appendChild(e), this.nodes.togglerAndButtonsWrapper.appendChild(this.nodes.conversionToggler), this.listeners.on(this.nodes.conversionToggler, "click", () => {
      this.Editor.ConversionToolbar.toggle((t) => {
        !t && this.opened ? this.flipper.activate() : this.opened && this.flipper.deactivate();
      });
    }), te() === !1 && this.tooltip.onHover(this.nodes.conversionToggler, Y.ui(K.ui.inlineToolbar.converter, "Convert to"), {
      placement: "top",
      hidingDelay: 100
    });
  }
  ...
  async setConversionTogglerContent() {
    ...
    this.nodes.conversionTogglerIcon.innerHTML = s.icon, this.nodes.conversionTogglerText.innerHTML = s.title || re(o);
  }
  /**
   ...
   */
  addToolsFiltered() {
    const e = v.get(), t = this.Editor.BlockManager.getBlock(e.anchorNode);
...
class Yo extends C {
  ...
  beforeKeydownProcessing(e) {
    this.needToolbarClosing(e) && Ve(e.keyCode) && (this.Editor.Toolbar.close(), this.Editor.ConversionToolbar.close(), e.ctrlKey || e.metaKey || e.altKey || e.shiftKey || (this.Editor.BlockManager.clearFocused(), this.Editor.BlockSelection.clearSelection(e)));
  }
  /**
   * Key up on Block:
  ...
  tabPressed(e) {
    ...
    if (!n)
      return;
    const s = n.isEmpty, a = n.tool.isDefault && s, l = !s && i.opened, c = !s && !v.isCollapsed && o.opened;
  ...
  backspace(e) {
    ...
    $e(i, n) ? this.mergeBlocks(n, i) : o.setToBlock(n, o.positions.END);
  }
  /**
  ...
  delete(e) {
    ...
    $e(i, n) ? this.mergeBlocks(i, n) : o.setToBlock(n, o.positions.START);
  }
  /**
   * Merge passed Blocks
   *
  ...
  arrowRightAndDown(e) {
    ...
    (e.keyCode === E.DOWN || e.keyCode === E.RIGHT && !this.isRtl ? this.Editor.Caret.navigateNext() : this.Editor.Caret.navigatePrevious()) ? e.preventDefault() : se(() => {
  ...
  arrowLeftAndUp(e) {
    ...
    (e.keyCode === E.UP || e.keyCode === E.LEFT && !this.isRtl ? this.Editor.Caret.navigatePrevious() : this.Editor.Caret.navigateNext()) ? e.preventDefault() : se(() => {
      this.Editor.BlockManager.currentBlock && this.Editor.BlockManager.currentBlock.updateCurrentInput();
    }, 20)(), this.Editor.BlockSelection.clearSelection(e);
  }
  /**
  ...
  needToolbarClosing(e) {
    const t = e.keyCode === E.ENTER && this.Editor.Toolbar.toolbox.opened, o = e.keyCode === E.ENTER && this.Editor.BlockSettings.opened, i = e.keyCode === E.ENTER && this.Editor.InlineToolbar.opened, n = e.keyCode === E.ENTER && this.Editor.ConversionToolbar.opened, s = e.keyCode === E.TAB;
...
class Te {
   ...
   */
  get nodes() {
    return Ze(this.workingArea.children);
  }
  /**
...
const We = "block-removed", Ye = "block-added", Ko = "block-moved", Ke = "block-changed";
class Xo {
  constructor() {
...
class Vo extends C {
  constructor() {
    super(...arguments), this._currentBlockIndex = -1, this._unfocusCallback = null, this._blocks = null;
  }
  /**
   * Returns current Block index
   *
   ...
   * @param callback
   */
  set unfocusCallback(e) {
    this._unfocusCallback = e;
  }
  /**
   * Call unfocus callback
   */
  ...
  callUnfocusCallback() {
    return this._unfocusCallback ? (this._unfocusCallback(), this._unfocusCallback = null, !0) : !1;
  }
  /**
   * returns first Block
   *
  ...
  insert({
    ...
    replace: s = !1,
    tunes: a = {},
    addBlockButtonClick: l,
    onFocusBlock: c
  } = {}) {
    let h = i;
    h === void 0 && (h = this.currentBlockIndex + (s ? 0 : 1));
    ...
    return s && this.blockDidMutated(We, this.getBlockByIndex(h), {
      index: h
    }), this._blocks.insert(h, u, s), this.blockDidMutated(Ye, u, {
      index: h,
      trigger: "ui_plus"
    }), n ? this.currentBlockIndex = h : h <= this.currentBlockIndex && this.currentBlockIndex++, u;
  }
  /**
   * Inserts several blocks at once
   *
  ...
  async update(e, t) {
    ...
    return this._blocks.replace(n, i), this.blockDidMutated(Ke, i, {
      index: n
    }), i;
  }
  /**
  ...
  insertDefaultBlockAtIndex(e, t = !1, o = "") {
    ...
    return this._blocks[e] = i, this.blockDidMutated(Ye, i, {
      index: e,
      trigger: o
  ...
  async mergeBlocks(e, t) {
    ...
    X(o) || await e.mergeWith(o), this.removeBlock(t), this.currentBlockIndex = this._blocks.indexOf(e);
  }
  /**
   * Remove passed Block
   *
  ...
  removeBlock(e, t = !0) {
    return new Promise((o) => {
      ...
      e.destroy(), this._blocks.remove(i), this.blockDidMutated(We, e, {
        index: i
  ...
  move(e, t = this.currentBlockIndex) {
    ...
    this._blocks.move(e, t), this.currentBlockIndex = e, this.blockDidMutated(Ko, this.currentBlock, {
  ...
  async convert(e, t, o) {
    ...
    const s = await e.exportDataAsString(), a = q(
      s,
      n.sanitizeConfig
    );
  ...
  bindBlockEvents(e) {
    ...
    this.readOnlyMutableListeners.on(e.holder, "keydown", (o) => {
      ...
      t.dragLeave(o);
    }), e.on("didMutated", (o) => this.blockDidMutated(Ke, o, {
  ...
  blockDidMutated(e, t, o) {
    ...
    return this.eventsDispatcher.emit(et, {
      event: i
    }), t;
  }
}
class Zo extends C {
   ...
   */
  toggleReadOnly() {
    v.get().removeAllRanges(), this.allBlocksSelected = !1;
  }
  /**
  ...
  clearSelection(e, t = !1) {
    ...
    const s = e && e instanceof KeyboardEvent, a = s && Ve(e.keyCode);
    if (this.anyBlockSelected && s && a && !v.isSelectionExists) {
  ...
  copySelectedBlocks(e) {
    ...
    this.selectedBlocks.forEach((n) => {
      const s = q(n.holder.innerHTML, this.sanitizerConfig), a = d.make("p");
...
`), i = t.innerHTML;
  ...
  selectBlockByIndex(e) {
    ...
    t.clearFocused();
    let o;
    isNaN(e) ? o = t.currentBlock : o = t.getBlockByIndex(e), this.selection.save(), v.get().removeAllRanges(), o.selected = !0, this.clearCache(), this.Editor.InlineToolbar.close();
  }
  /**
   ...
   */
  selectAllBlocks() {
    this.selection.save(), v.get().removeAllRanges(), this.allBlocksSelected = !0, this.Editor.InlineToolbar.close();
  }
}
class xe extends C {
  /**
   ...
   */
  get isAtStart() {
    const e = v.get(), t = d.getDeepestNode(this.Editor.BlockManager.currentBlock.currentInput);
    let o = e.focusNode;
   ...
   */
  set(e, t = 0) {
    const { top: o, bottom: i } = v.setCursor(e, t), { innerHeight: n } = window;
  ...
  insertContentAtCaretPosition(e) {
    const t = document.createDocumentFragment(), o = document.createElement("div"), i = v.get(), n = v.range;
...
class qo extends C {
    ...
    super(...arguments), this.onMouseUp = () => {
      ...
      if (!(!i || !n) && n !== i) {
        if (i === this.firstSelectedBlock) {
          v.get().removeAllRanges(), i.selected = !0, n.selected = !0, o.clearCache();
          return;
        }
  ...
  toggleBlockSelectedState(e = !0) {
    ...
    this.lastSelectedBlock || (this.lastSelectedBlock = this.firstSelectedBlock = t.currentBlock), this.firstSelectedBlock === this.lastSelectedBlock && (this.firstSelectedBlock.selected = !0, o.clearCache(), v.get().removeAllRanges());
  ...
  enableCrossBlockSelection(e) {
    ...
    v.isCollapsed || this.Editor.BlockSelection.clearSelection(e), t.nodes.redactor.contains(e.target) ? this.watchSelection(e) : this.Editor.BlockSelection.clearSelection(e);
  }
  /**
...
class Go extends C {
  ...
  async processDrop(e) {
    ...
    e.preventDefault(), t.blocks.forEach((s) => {
      s.dropTarget = !1;
    }), v.isAtEditor && !v.isCollapsed && this.isStartedAtEditor && document.execCommand("delete"), this.isStartedAtEditor = !1;
   ...
   */
  processDragStart() {
    v.isAtEditor && !v.isCollapsed && (this.isStartedAtEditor = !0), this.Editor.InlineToolbar.close();
  }
  /**
...
class Jo extends C {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    ...
    }), this.eventsDispatcher.on(et, (o) => {
      this.particularBlockChanged(o.event);
    }), this.eventsDispatcher.on(tt, () => {
      this.disable();
    }), this.eventsDispatcher.on(ot, () => {
      this.enable();
    });
  }
  /**
...
const vt = class xt extends C {
  constructor() {
    super(...arguments), this.MIME_TYPE = "application/x-editor-js", this.toolsTags = {}, this.tagsByTool = {}, this.toolsPatterns = [], this.toolsFiles = {}, this.exceptionList = [], this.processTool = (e) => {
      ...
      !i || this.isNativeBehaviour(e.target) && !e.clipboardData.types.includes("Files") || i && this.exceptionList.includes(i.name) || (e.preventDefault(), this.processDataTransfer(e.clipboardData, e.target), t.clearFocused(), o.close());
    };
  }
  /**
   ...
   */
  async processDataTransfer(e, t, o = !1) {
    const { Tools: i } = this.Editor, n = e.types, s = t;
    if ((n.includes ? n.includes("Files") : n.contains("Files")) && !X(this.toolsFiles)) {
      await this.processFiles(e.files);
      return;
    }
    const l = e.getData(this.MIME_TYPE), c = e.getData("text/plain");
    let h = e.getData("text/html");
    if (l)
      try {
        this.insertEditorJSData(JSON.parse(l));
        return;
      } catch {
      }
    o && c.trim() && h.trim() && (h = "<p>" + (h.trim() ? h : c) + "</p>");
    const u = Object.keys(this.toolsTags).reduce((p, m) => (p[m.toLowerCase()] = this.toolsTags[m].sanitizationConfig ?? {}, p), {}), f = Object.assign({}, u, i.getAllInlineToolsSanitizeConfig(), { br: {} }), k = q(h, f);
    !k.trim() || k.trim() === c || !d.isHTMLString(k) ? await this.processText(c, s) : await this.processText(k, s, !0);
  }
  /**
   ...
   */
  async processText(e, t, o = !1) {
    const { Caret: i, BlockManager: n } = this.Editor, s = o ? this.processHTML(e, t) : this.processPlain(e);
    if (!s.length)
      return;
    if (s.length === 1) {
    ...
    const l = n.currentBlock && n.currentBlock.tool.isDefault && n.currentBlock.isEmpty;
    s.map(
      async (c, h) => this.insertBlock(c, h === 0 && l)
    ), n.currentBlock && i.setToBlock(n.currentBlock, i.positions.END);
  }
  /**
  ...
  getFilesConfig(e) {
    ...
    !o && !i || (o && !Array.isArray(o) && (L(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), o = []), i && !Array.isArray(i) && (L(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), i = []), i && (i = i.filter((n) => Pt(n) ? !0 : (L(`MIME type value «${n}» for the «${e.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[e.name] = {
      extensions: o || [],
      mimeTypes: i || []
    });
  }
   ...
   */
  async processFile(e) {
    const t = Dt(e), o = Object.entries(this.toolsFiles).find(([s, { mimeTypes: a, extensions: l }]) => {
      const [c, h] = e.type.split("/"), u = l.find((k) => k.toLowerCase() === t.toLowerCase()), f = a.find((k) => {
        const [p, m] = k.split("/");
        return p === c && (m === h || m === "*");
      });
      return !!u || !!f;
   ...
   */
  processHTML(e, t) {
    const { Tools: o } = this.Editor, i = d.make("DIV");
    return i.innerHTML = e, this.getNodes(i).map((s) => {
      let a, l = o.defaultTool, c = !1;
      switch (s.nodeType) {
        case Node.DOCUMENT_FRAGMENT_NODE:
          a = d.make("div"), a.appendChild(s);
          break;
        case Node.ELEMENT_NODE:
          a = s, c = !0, this.toolsTags[a.tagName] && (l = this.toolsTags[a.tagName].tool);
          break;
      }
      const { tags: h } = l.pasteConfig || { tags: [] }, u = h.reduce((p, m) => (this.collectTagNames(m).forEach((A) => {
        const O = z(m) ? m[A] : null;
        p[A.toLowerCase()] = O || {};
      }), p), {}), f = Object.assign({}, u, l.baseSanitizeConfig);
      if (a.tagName.toLowerCase() === "table") {
        const p = q(a.outerHTML, f);
        a = d.make("div", void 0, {
          innerHTML: p
        }).firstChild;
      } else
        a.innerHTML = q(a.innerHTML, f);
      ...
      const a = d.isEmpty(s.content), l = d.isSingleTag(s.content);
      return !a || l;
    });
  }
  /**
  ...
  processElementNode(e, t, o) {
    const i = Object.keys(this.toolsTags), n = e, { tool: s } = this.toolsTags[n.tagName] || {}, a = this.tagsByTool[s == null ? void 0 : s.name] || [], l = i.includes(n.tagName), c = d.blockElements.includes(n.tagName.toLowerCase()), h = Array.from(n.children).some(
...
class fe extends C {
  ...
  changingRectangle(e) {
    ...
    this.rectCrossesBlocks = !(n || s), this.isRectSelectionActivated || (this.rectCrossesBlocks = !1, this.isRectSelectionActivated = !0, this.shrinkRectangleToPoint(), this.overlayRectangle.style.display = "block"), this.updateRectangleSize(), this.Editor.Toolbar.close(), i !== void 0 && (this.trySelectNextBlock(i), this.inverseSelection(), v.get().removeAllRanges());
  }
  /**
  ...
  genInfoForMouseSelection() {
    ...
    let s;
    n !== void 0 && (s = this.Editor.BlockManager.blocks.findIndex((u) => u.holder === n.holder));
  ...
  trySelectNextBlock(e) {
    ...
    let l = s;
    o > 1 && (l = a ? i : n);
    const c = e > this.stackOfSelected[o - 1] && l === i, h = e < this.stackOfSelected[o - 1] && l === n, f = !(c || h || l === s);
    ...
    return new Promise((t) => {
      ...
      if (e.length === 0)
        ...
        const n = e.map(({ type: s, data: a, tunes: l, id: c }) => {
          o.available.has(s) === !1 && (V(`Tool «${s}» is not found. Check 'tools' property at the Editor.js config.`, "warn"), a = this.composeStubDataForTool(s, a, c), s = o.stubTool);
          let h;
          try {
            h = i.composeBlock({
              id: c,
...
class oi extends C {
  ...
  async save() {
    ...
    try {
      ...
      const n = await Promise.all(i), s = await st(n, (a) => t.blockTools.get(a).sanitizeConfig);
      return this.makeOutput(s);
    } catch (n) {
      V("Saving failed due to the Error %o", "error", n);
    }
  }
  /**
   * Saves and validates
    ...
    return function(t) {
      ...
      function h(y, x) {
        for (var w = {}, I = [], R = 0; R < y.length; R++) {
          ...
          w[g] = B + 1;
          var _ = c(T), S = { css: b[1], media: b[2], sourceMap: b[3] };
          _ !== -1 ? (l[_].references++, l[_].updater(S)) : l.push({ identifier: T, updater: O(S, x), references: 1 }), I.push(T);
        }
        return I;
      }
      function u(y) {
...
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(b)))), " */")), y.styleSheet)
      ...
      function O(y, x) {
        ...
        if (x.singleton) {
          var b = A++;
          w = N || (N = u(x)), I = p.bind(null, w, b, !1), R = p.bind(null, w, b, !0);
        } else
          w = u(x), I = m.bind(null, w, x), R = function() {
            (function(g) {
      ...
      t.exports = function(y, x) {
        ...
        return function(I) {
          if (I = I || [], Object.prototype.toString.call(I) === "[object Array]") {
            ...
            for (var g = h(I, x), B = 0; B < w.length; B++) {
              var T = c(w[B]);
          ...
          return this.map(function(a) {
            var l = function(c, h) {
              ...
              if (h && typeof btoa == "function") {
                var k = (m = f, N = btoa(unescape(encodeURIComponent(JSON.stringify(m)))), A = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(N), "/*# ".concat(A, " */")), p = f.sources.map(function(O) {
                  return "/*# sourceURL=".concat(f.sourceRoot || "").concat(O, " */");
                });
                return [u].concat(p).concat([k]).join(`
`);
              }
              var m, N, A;
              return [u].join(`
`);
      ...
      var a = function() {
        function l(c) {
          var h = c.data, u = c.config, f = c.api, k = c.readOnly;
          (function(p, m) {
            if (!(p instanceof m))
              throw new TypeError("Cannot call a class as a function");
...
class yt {
   ...
   */
  make() {
    const e = d.make("div", this.CSS.wrapper), t = _o, o = d.make("div", this.CSS.info), i = d.make("div", this.CSS.title, {
...
var ai = Object.defineProperty, li = Object.getOwnPropertyDescriptor, Bt = (r, e, t, o) => {
...
Bt([
  le
], Fe.prototype, "sanitizeConfig", 1);
Bt([
  le
], Fe.prototype, "baseSanitizeConfig", 1);
class ci {
  /**
   * @class
...
Ct.isTune = !0;
var di = Object.defineProperty, hi = Object.getOwnPropertyDescriptor, ui = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? hi(e, t) : e, n = r.length - 1, s; n >= 0; n--)
    (s = r[n]) && (i = (o ? s(e, t, i) : s(i)) || i);
...
const pi = `:root{--selectionColor: #e1f2ff;--inlineSelectionColor: #d4ecff;--bg-light: #eff2f5;--grayText: #707684;--color-dark: #1d202b;--color-active-icon: #388ae5;--color-gray-border: rgba(201, 201, 204, .48);--content-width: 650px;--narrow-mode-right-padding: 50px;--toolbar-buttons-size: 40px;--toolbox-buttons-size--height: 40px;--toolbox-buttons-size--width: 36px;--toolbox-buttons-size--mobile: 36px;--icon-size: 20px;--icon-size--mobile: 28px;--block-padding-vertical: .4em;--color-confirm: #e24a4a;--color-line-gray: #eff0f1 }.codex-editor{position:relative;-webkit-box-sizing:border-box;box-sizing:border-box;z-index:1}.codex-editor .hide{display:none}.codex-editor__redactor [contenteditable]:empty:after{content:"\\feff"}@media (min-width: 651px){.codex-editor--narrow .codex-editor__redactor{margin-right:50px}}@media (min-width: 651px){.codex-editor--narrow.codex-editor--rtl .codex-editor__redactor{margin-left:50px;margin-right:0}}@media (min-width: 651px){.codex-editor--narrow .ce-toolbar__actions{right:-5px}}.codex-editor-copyable{position:absolute;height:1px;width:1px;top:-400%;opacity:.001}.codex-editor-overlay{position:fixed;top:0;left:0;right:0;bottom:0;z-index:999;pointer-events:none;overflow:hidden}.codex-editor-overlay__container{position:relative;pointer-events:auto;z-index:0}.codex-editor-overlay__rectangle{position:absolute;pointer-events:none;background-color:#2eaadc33;border:1px solid transparent}.codex-editor svg{max-height:100%}.codex-editor path{stroke:currentColor}.codex-editor ::-moz-selection{background-color:#d4ecff}.codex-editor ::selection{background-color:#d4ecff}.codex-editor--toolbox-opened [contentEditable=true][data-placeholder]:focus:before{opacity:0!important}.ce-scroll-locked{overflow:hidden}.ce-scroll-locked--hard{overflow:hidden;top:calc(-1 * var(--window-scroll-offset));position:fixed;width:100%}.ce-toolbar{position:absolute;left:0;right:0;top:0;-webkit-transition:opacity .1s ease;transition:opacity .1s ease;will-change:opacity,top;display:none}.ce-toolbar--opened{display:block}.ce-toolbar__content{max-width:650px;margin:0 auto;position:relative}.ce-toolbar__plus{color:#1d202b;cursor:pointer;width:36px;height:40px;border-radius:7px;display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;-ms-flex-negative:0;flex-shrink:0}@media (max-width: 650px){.ce-toolbar__plus{width:36px;height:36px}}@media (hover: hover){.ce-toolbar__plus:hover{background-color:#eff2f5}}.ce-toolbar__plus--active{background-color:#eff2f5;-webkit-animation:bounceIn .75s 1;animation:bounceIn .75s 1;-webkit-animation-fill-mode:forwards;animation-fill-mode:forwards}.ce-toolbar__plus-shortcut{opacity:.6;word-spacing:-2px;margin-top:5px}@media (max-width: 650px){.ce-toolbar__plus{position:absolute;background-color:#fff;border:1px solid rgba(37,37,92,.1);//box-shadow: 0 3px 15px -3px rgba(13,20,33,.13);-webkit-filter:drop-shadow(0 8px 32px rgba(0,5,19,.08));filter:drop-shadow(0 8px 32px rgba(0,5,19,.08));border-radius:8px;z-index:2;position:static}.ce-toolbar__plus--left-oriented:before{left:15px;margin-left:0}.ce-toolbar__plus--right-oriented:before{left:auto;right:15px;margin-left:0}}.ce-toolbar__actions{position:absolute;right:100%;opacity:0;display:-webkit-box;display:-ms-flexbox;display:flex;padding-right:5px}.ce-toolbar__actions--opened{opacity:1}@media (max-width: 650px){.ce-toolbar__actions{right:auto}}.ce-toolbar__settings-btn{color:#1d202b;width:36px;height:40px;border-radius:7px;display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;margin-left:3px;cursor:pointer;user-select:none}@media (max-width: 650px){.ce-toolbar__settings-btn{width:36px;height:36px}}@media (hover: hover){.ce-toolbar__settings-btn:hover{background-color:#eff2f5}}.ce-toolbar__settings-btn--active{background-color:#eff2f5;-webkit-animation:bounceIn .75s 1;animation:bounceIn .75s 1;-webkit-animation-fill-mode:forwards;animation-fill-mode:forwards}@media (min-width: 651px){.ce-toolbar__settings-btn{width:24px}}.ce-toolbar__settings-btn--hidden{display:none}@media (max-width: 650px){.ce-toolbar__settings-btn{position:absolute;background-color:#fff;border:1px solid rgba(37,37,92,.1);//box-shadow: 0 3px 15px -3px rgba(13,20,33,.13);-webkit-filter:drop-shadow(0 8px 32px rgba(0,5,19,.08));filter:drop-shadow(0 8px 32px rgba(0,5,19,.08));border-radius:8px;z-index:2;position:static}.ce-toolbar__settings-btn--left-oriented:before{left:15px;margin-left:0}.ce-toolbar__settings-btn--right-oriented:before{left:auto;right:15px;margin-left:0}}.ce-toolbar__plus svg,.ce-toolbar__settings-btn svg{width:24px;height:24px}@media (min-width: 651px){.codex-editor--narrow .ce-toolbar__plus{left:5px}}@media (min-width: 651px){.codex-editor--narrow .ce-toolbox .ce-popover{right:0;left:auto;left:initial}}.ce-inline-toolbar{position:absolute;background-color:#fff;border:1px solid rgba(37,37,92,.1);//box-shadow: 0 3px 15px -3px rgba(13,20,33,.13);-webkit-filter:drop-shadow(0 8px 32px rgba(0,5,19,.08));filter:drop-shadow(0 8px 32px rgba(0,5,19,.08));border-radius:8px;z-index:2;-webkit-transform:translateX(-50%) translateY(8px) scale(.9);transform:translate(-50%) translateY(8px) scale(.9);opacity:0;visibility:hidden;-webkit-transition:opacity .25s ease,-webkit-transform .15s ease;transition:opacity .25s ease,-webkit-transform .15s ease;transition:transform .15s ease,opacity .25s ease;transition:transform .15s ease,opacity .25s ease,-webkit-transform .15s ease;will-change:transform,opacity;top:0;left:0;z-index:3}.ce-inline-toolbar--left-oriented:before{left:15px;margin-left:0}.ce-inline-toolbar--right-oriented:before{left:auto;right:15px;margin-left:0}.ce-inline-toolbar--showed{opacity:1;visibility:visible;-webkit-transform:translateX(-50%);transform:translate(-50%)}.ce-inline-toolbar--left-oriented{-webkit-transform:translateX(-23px) translateY(8px) scale(.94);transform:translate(-23px) translateY(8px) scale(.94)}.ce-inline-toolbar--left-oriented.ce-inline-toolbar--showed{-webkit-transform:translateX(-23px);transform:translate(-23px)}.ce-inline-toolbar--right-oriented{-webkit-transform:translateX(-100%) translateY(8px) scale(.94);transform:translate(-100%) translateY(8px) scale(.94);margin-left:23px}.ce-inline-toolbar--right-oriented.ce-inline-toolbar--showed{-webkit-transform:translateX(-100%);transform:translate(-100%)}.ce-inline-toolbar [hidden]{display:none!important}.ce-inline-toolbar__toggler-and-button-wrapper{display:-webkit-box;display:-ms-flexbox;display:flex;width:100%}.ce-inline-toolbar__buttons{display:-webkit-box;display:-ms-flexbox;display:flex}.ce-inline-toolbar__dropdown{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;height:40px;padding:0 9px 0 10px;margin:0;-webkit-box-align:center;-ms-flex-align:center;align-items:center;cursor:pointer;max-width:190px;width:190px;position:relative;-webkit-box-sizing:border-box;box-sizing:border-box}@media (hover: hover){.ce-inline-toolbar__dropdown:hover{background-color:#eff2f5}}.ce-inline-toolbar__dropdown:after{content:"";display:block;position:absolute;right:0;width:1px;height:24px;background:rgba(37,37,92,.1)}.ce-inline-toolbar__dropdown--hidden{display:none}@media (max-width: 767px){.ce-inline-toolbar__dropdown{width:auto}}.ce-inline-toolbar__dropdown-content{display:-webkit-box;display:-ms-flexbox;display:flex;font-weight:500;font-size:14px}.ce-inline-toolbar__dropdown-content svg{height:24px}.ce-inline-toolbar__dropdown-icon{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;width:24px;height:24px;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;margin-right:8px}.ce-inline-toolbar__dropdown-icon svg{width:24px;height:24px}.ce-inline-toolbar__dropdown-text{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:start;-ms-flex-pack:start;justify-content:flex-start;margin-right:4px;font-weight:400}@media (max-width: 767px){.ce-inline-toolbar__dropdown-text{display:none}}.ce-inline-toolbar__dropdown .icon--toggler-down{margin-left:auto}.ce-inline-toolbar__shortcut{opacity:.6;word-spacing:-3px;margin-top:3px}.ce-inline-tool{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;padding:6px 1px;cursor:pointer;border:0;outline:none;background-color:transparent;vertical-align:bottom;color:inherit;margin:0;border-radius:0;line-height:normal;width:auto;min-width:36px}.ce-inline-tool svg{width:20px;height:20px}@media (max-width: 650px){.ce-inline-tool svg{width:28px;height:28px}}@media (hover: hover){.ce-inline-tool:hover{background-color:#eff2f5}}.ce-inline-tool--active{color:#388ae5}.ce-inline-tool--focused{background:rgba(34,186,255,.08)!important}.ce-inline-tool--focused{-webkit-box-shadow:inset 0 0 0 1px rgba(7,161,227,.08);box-shadow:inset 0 0 0 1px #07a1e314}.ce-inline-tool--focused-animated{-webkit-animation-name:buttonClicked;animation-name:buttonClicked;-webkit-animation-duration:.25s;animation-duration:.25s}.ce-inline-tool .icon{height:24px}.ce-inline-tool--link .icon--unlink,.ce-inline-tool--unlink .icon--link{display:none}.ce-inline-tool--unlink .icon--unlink{display:inline-block;margin-bottom:-1px}.ce-inline-tool-label{position:absolute;right:-8px;top:44px;outline:none;border:0;border-radius:0 0 4px 4px;background:#fff;margin:0;font-size:13px;padding:10px;width:100%;max-width:280px;-webkit-box-sizing:border-box;box-sizing:border-box;display:none;font-weight:500;border-top:1px solid rgba(201,201,204,.48)}.ce-inline-tool-label span{cursor:pointer;display:block;position:absolute;opacity:0;visibility:hidden;right:12px;top:50%;width:20px;height:20px;-webkit-transform:translateY(-50%);transform:translateY(-50%)}.ce-inline-tool-label span:first-of-type{right:44px}.ce-inline-tool-label span.ce-inline-tool-input-clean--showed{visibility:visible;opacity:1;-webkit-transition:opacity .2s ease .02s;transition:opacity .2s ease .02s}.ce-inline-tool-label--showed{display:-webkit-box;display:-ms-flexbox;display:flex}.ce-inline-tool-input{width:100%;padding-right:76px;outline:none;border:none;color:#04003d}.ce-inline-tool-input::-webkit-input-placeholder{color:#707684}.ce-inline-tool-input::-moz-placeholder{color:#707684}.ce-inline-tool-input:-ms-input-placeholder{color:#707684}.ce-inline-tool-input::-ms-input-placeholder{color:#707684}.ce-inline-tool-input::placeholder{color:#707684}.ce-inline-tool--active{color:#0075ff}.ce-inline-tool--hover{background-color:#eff2f5}.cdx-underline{-webkit-text-decoration:underline;text-decoration:underline}.ce-conversion-toolbar{position:absolute;background-color:#fff;border:1px solid rgba(37,37,92,.1);//box-shadow: 0 3px 15px -3px rgba(13,20,33,.13);-webkit-filter:drop-shadow(0 8px 32px rgba(0,5,19,.08));filter:drop-shadow(0 8px 32px rgba(0,5,19,.08));border-radius:8px;z-index:2;opacity:0;visibility:hidden;will-change:transform,opacity;-webkit-transition:opacity .1s ease,-webkit-transform .1s ease;transition:opacity .1s ease,-webkit-transform .1s ease;transition:transform .1s ease,opacity .1s ease;transition:transform .1s ease,opacity .1s ease,-webkit-transform .1s ease;-webkit-transform:translateY(-8px);transform:translateY(-8px);left:-1px;width:200px;margin-top:5px;-webkit-box-sizing:content-box;box-sizing:content-box;overflow:hidden}.ce-conversion-toolbar--left-oriented:before{left:15px;margin-left:0}.ce-conversion-toolbar--right-oriented:before{left:auto;right:15px;margin-left:0}.ce-conversion-toolbar--showed{opacity:1;visibility:visible;-webkit-transform:none;transform:none}.ce-conversion-toolbar [hidden]{display:none!important}.ce-conversion-toolbar__buttons{display:-webkit-box;display:-ms-flexbox;display:flex}.ce-conversion-toolbar__label{color:#707684;font-size:11px;font-weight:500;letter-spacing:.33px;padding:10px 10px 5px;text-transform:uppercase}.ce-conversion-tool{display:-webkit-box;display:-ms-flexbox;display:flex;padding:5px 10px;font-size:14px;line-height:20px;font-weight:500;cursor:pointer;-webkit-box-align:center;-ms-flex-align:center;align-items:center;position:relative}.ce-conversion-tool .icon--tick{display:none;position:absolute;right:12px}.ce-conversion-tool--select{position:relative}.ce-conversion-tool--select .icon--tick{display:block}.ce-conversion-tool--focused{background:transparent!important}.ce-conversion-tool--focused{-webkit-box-shadow:inset 0 0 0 1px rgba(7,161,227,.08);box-shadow:inset 0 0 0 1px #07a1e314}.ce-conversion-tool--focused-animated{-webkit-animation-name:buttonClicked;animation-name:buttonClicked;-webkit-animation-duration:.25s;animation-duration:.25s}.ce-conversion-tool:hover{background:#eff2f5}.ce-conversion-tool__icon{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;width:24px;height:24px;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;margin-right:8px}.ce-conversion-tool__icon svg{width:24px;height:24px}.ce-conversion-tool--last{margin-right:0!important}.ce-conversion-tool--active{color:#388ae5!important}.ce-conversion-tool--active{-webkit-animation:bounceIn .75s 1;animation:bounceIn .75s 1;-webkit-animation-fill-mode:forwards;animation-fill-mode:forwards}.ce-conversion-tool__secondary-label{color:#707684;font-size:12px;margin-left:auto;white-space:nowrap;letter-spacing:-.1em;padding-right:5px;margin-bottom:-2px;opacity:.6}@media (max-width: 650px){.ce-conversion-tool__secondary-label{display:none}}.ce-settings__button{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;padding:6px 1px;border-radius:3px;cursor:pointer;border:0;outline:none;background-color:transparent;vertical-align:bottom;color:inherit;margin:0;line-height:32px}.ce-settings__button svg{width:20px;height:20px}@media (max-width: 650px){.ce-settings__button svg{width:28px;height:28px}}@media (hover: hover){.ce-settings__button:hover{background-color:#eff2f5}}.ce-settings__button--active{color:#388ae5}.ce-settings__button--focused{background:rgba(34,186,255,.08)!important}.ce-settings__button--focused{-webkit-box-shadow:inset 0 0 0 1px rgba(7,161,227,.08);box-shadow:inset 0 0 0 1px #07a1e314}.ce-settings__button--focused-animated{-webkit-animation-name:buttonClicked;animation-name:buttonClicked;-webkit-animation-duration:.25s;animation-duration:.25s}.ce-settings__button:not(:nth-child(3n+3)){margin-right:3px}.ce-settings__button:nth-child(n+4){margin-top:3px}.ce-settings__button--disabled{cursor:not-allowed!important}.ce-settings__button--disabled{opacity:.3}.ce-settings__button--selected{color:#388ae5}@media (min-width: 651px){.codex-editor--narrow .ce-settings .ce-popover{right:0;left:auto;left:initial}}@-webkit-keyframes fade-in{0%{opacity:0}to{opacity:1}}@keyframes fade-in{0%{opacity:0}to{opacity:1}}.ce-block{-webkit-animation:fade-in .3s ease;animation:fade-in .3s ease;-webkit-animation-fill-mode:none;animation-fill-mode:none;-webkit-animation-fill-mode:initial;animation-fill-mode:initial}.ce-block:first-of-type{margin-top:0}.ce-block--selected .ce-block__content{background:#e1f2ff}.ce-block--selected .ce-block__content [contenteditable]{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.ce-block--selected .ce-block__content img,.ce-block--selected .ce-block__content .ce-stub{opacity:.55}.ce-block--stretched .ce-block__content{max-width:none}.ce-block__content{position:relative;max-width:650px;margin:0 auto;-webkit-transition:background-color .15s ease;transition:background-color .15s ease}.ce-block--drop-target .ce-block__content:before{content:"";position:absolute;top:100%;left:-20px;margin-top:-1px;height:8px;width:8px;border:solid #388ae5;border-width:1px 1px 0 0;-webkit-transform-origin:right;transform-origin:right;-webkit-transform:rotate(45deg);transform:rotate(45deg)}.ce-block--drop-target .ce-block__content:after{content:"";position:absolute;top:100%;height:1px;width:100%;color:#388ae5;background:repeating-linear-gradient(90deg,#388ae5,#388ae5 1px,#fff 1px,#fff 6px)}.ce-block a{cursor:pointer;-webkit-text-decoration:underline;text-decoration:underline}.ce-block b{font-weight:700}.ce-block i{font-style:italic}.ce-block u{-webkit-text-decoration:underline;text-decoration:underline}@media (min-width: 651px){.codex-editor--narrow .ce-block--focused{margin-right:-50px;padding-right:50px}}@-webkit-keyframes bounceIn{0%,20%,40%,60%,80%,to{-webkit-animation-timing-function:cubic-bezier(.215,.61,.355,1);animation-timing-function:cubic-bezier(.215,.61,.355,1)}0%{-webkit-transform:scale3d(.9,.9,.9);transform:scale3d(.9,.9,.9)}20%{-webkit-transform:scale3d(1.03,1.03,1.03);transform:scale3d(1.03,1.03,1.03)}60%{-webkit-transform:scale3d(1,1,1);transform:scaleZ(1)}}@keyframes bounceIn{0%,20%,40%,60%,80%,to{-webkit-animation-timing-function:cubic-bezier(.215,.61,.355,1);animation-timing-function:cubic-bezier(.215,.61,.355,1)}0%{-webkit-transform:scale3d(.9,.9,.9);transform:scale3d(.9,.9,.9)}20%{-webkit-transform:scale3d(1.03,1.03,1.03);transform:scale3d(1.03,1.03,1.03)}60%{-webkit-transform:scale3d(1,1,1);transform:scaleZ(1)}}@-webkit-keyframes selectionBounce{0%,20%,40%,60%,80%,to{-webkit-animation-timing-function:cubic-bezier(.215,.61,.355,1);animation-timing-function:cubic-bezier(.215,.61,.355,1)}50%{-webkit-transform:scale3d(1.01,1.01,1.01);transform:scale3d(1.01,1.01,1.01)}70%{-webkit-transform:scale3d(1,1,1);transform:scaleZ(1)}}@keyframes selectionBounce{0%,20%,40%,60%,80%,to{-webkit-animation-timing-function:cubic-bezier(.215,.61,.355,1);animation-timing-function:cubic-bezier(.215,.61,.355,1)}50%{-webkit-transform:scale3d(1.01,1.01,1.01);transform:scale3d(1.01,1.01,1.01)}70%{-webkit-transform:scale3d(1,1,1);transform:scaleZ(1)}}@-webkit-keyframes buttonClicked{0%,20%,40%,60%,80%,to{-webkit-animation-timing-function:cubic-bezier(.215,.61,.355,1);animation-timing-function:cubic-bezier(.215,.61,.355,1)}0%{-webkit-transform:scale3d(.95,.95,.95);transform:scale3d(.95,.95,.95)}60%{-webkit-transform:scale3d(1.02,1.02,1.02);transform:scale3d(1.02,1.02,1.02)}80%{-webkit-transform:scale3d(1,1,1);transform:scaleZ(1)}}@keyframes buttonClicked{0%,20%,40%,60%,80%,to{-webkit-animation-timing-function:cubic-bezier(.215,.61,.355,1);animation-timing-function:cubic-bezier(.215,.61,.355,1)}0%{-webkit-transform:scale3d(.95,.95,.95);transform:scale3d(.95,.95,.95)}60%{-webkit-transform:scale3d(1.02,1.02,1.02);transform:scale3d(1.02,1.02,1.02)}80%{-webkit-transform:scale3d(1,1,1);transform:scaleZ(1)}}.cdx-block{padding:.4em 0}.cdx-block::-webkit-input-placeholder{line-height:normal!important}.cdx-input{border:1px solid rgba(201,201,204,.48);-webkit-box-shadow:inset 0 1px 2px 0 rgba(35,44,72,.06);box-shadow:inset 0 1px 2px #232c480f;border-radius:3px;padding:10px 12px;outline:none;width:100%;-webkit-box-sizing:border-box;box-sizing:border-box}.cdx-input[data-placeholder]:before{position:static!important}.cdx-input[data-placeholder]:before{display:inline-block;width:0;white-space:nowrap;pointer-events:none}.cdx-settings-button{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;padding:6px 1px;border-radius:3px;cursor:pointer;border:0;outline:none;background-color:transparent;vertical-align:bottom;color:inherit;margin:0;min-width:var(--toolbox-buttons-size);min-height:var(--toolbox-buttons-size)}.cdx-settings-button svg{width:20px;height:20px}@media (max-width: 650px){.cdx-settings-button svg{width:28px;height:28px}}@media (hover: hover){.cdx-settings-button:hover{background-color:#eff2f5}}.cdx-settings-button--focused{background:rgba(34,186,255,.08)!important}.cdx-settings-button--focused{-webkit-box-shadow:inset 0 0 0 1px rgba(7,161,227,.08);box-shadow:inset 0 0 0 1px #07a1e314}.cdx-settings-button--focused-animated{-webkit-animation-name:buttonClicked;animation-name:buttonClicked;-webkit-animation-duration:.25s;animation-duration:.25s}.cdx-settings-button--active{color:#388ae5}.cdx-settings-button svg{width:auto;height:auto}@media (max-width: 650px){.cdx-settings-button{width:36px;height:36px;border-radius:8px}}.cdx-loader{position:relative;border:1px solid rgba(201,201,204,.48)}.cdx-loader:before{content:"";position:absolute;left:50%;top:50%;width:18px;height:18px;margin:-11px 0 0 -11px;border:2px solid rgba(201,201,204,.48);border-left-color:#388ae5;border-radius:50%;-webkit-animation:cdxRotation 1.2s infinite linear;animation:cdxRotation 1.2s infinite linear}@-webkit-keyframes cdxRotation{0%{-webkit-transform:rotate(0deg);transform:rotate(0)}to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@keyframes cdxRotation{0%{-webkit-transform:rotate(0deg);transform:rotate(0)}to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}.cdx-button{padding:13px;border-radius:3px;border:1px solid rgba(201,201,204,.48);font-size:14.9px;background:#fff;-webkit-box-shadow:0 2px 2px 0 rgba(18,30,57,.04);box-shadow:0 2px 2px #121e390a;color:#707684;text-align:center;cursor:pointer}@media (hover: hover){.cdx-button:hover{background:#FBFCFE;-webkit-box-shadow:0 1px 3px 0 rgba(18,30,57,.08);box-shadow:0 1px 3px #121e3914}}.cdx-button svg{height:20px;margin-right:.2em;margin-top:-2px}.ce-stub{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;padding:12px 18px;margin:10px 0;border-radius:10px;background:#eff2f5;border:1px solid #eff0f1;color:#707684;font-size:14px}.ce-stub svg{width:20px;height:20px}.ce-stub__info{margin-left:14px}.ce-stub__title{font-weight:500;text-transform:capitalize}.codex-editor.codex-editor--rtl{direction:rtl}.codex-editor.codex-editor--rtl .cdx-list{padding-left:0;padding-right:40px}.codex-editor.codex-editor--rtl .ce-toolbar__plus{right:calc(var(--toolbox-buttons-size) * -1);left:auto}.codex-editor.codex-editor--rtl .ce-toolbar__actions{right:auto;left:calc(var(--toolbox-buttons-size) * -1)}@media (max-width: 650px){.codex-editor.codex-editor--rtl .ce-toolbar__actions{margin-left:0;margin-right:auto;padding-right:0;padding-left:10px}}.codex-editor.codex-editor--rtl .ce-settings{left:5px;right:auto}.codex-editor.codex-editor--rtl .ce-settings:before{right:auto;left:25px}.codex-editor.codex-editor--rtl .ce-settings__button:not(:nth-child(3n+3)){margin-left:3px;margin-right:0}.codex-editor.codex-editor--rtl .ce-conversion-tool__icon{margin-right:0;margin-left:10px}.codex-editor.codex-editor--rtl .ce-inline-toolbar__dropdown{border-right:0px solid transparent;border-left:1px solid rgba(201,201,204,.48);margin:0 -6px 0 6px}.codex-editor.codex-editor--rtl .ce-inline-toolbar__dropdown .icon--toggler-down{margin-left:0;margin-right:4px}@media (min-width: 651px){.codex-editor--narrow.codex-editor--rtl .ce-toolbar__plus{left:0;right:5px}}@media (min-width: 651px){.codex-editor--narrow.codex-editor--rtl .ce-toolbar__actions{left:-5px}}.cdx-search-field{--icon-margin-right: 10px;background:rgba(232,232,235,.49);border:1px solid rgba(226,226,229,.2);border-radius:6px;padding:2px;display:grid;grid-template-columns:auto auto 1fr;grid-template-rows:auto}.cdx-search-field__icon{width:var(--toolbox-buttons-size);height:var(--toolbox-buttons-size);display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;margin-right:var(--icon-margin-right)}.cdx-search-field__icon svg{width:20px;height:20px;color:#707684}.cdx-search-field__input{font-size:14px;outline:none;font-weight:500;font-family:inherit;border:0;background:transparent;margin:0;padding:0;line-height:22px;min-width:calc(100% - var(--toolbox-buttons-size) - var(--icon-margin-right))}.cdx-search-field__input::-webkit-input-placeholder{color:#707684;font-weight:500}.cdx-search-field__input::-moz-placeholder{color:#707684;font-weight:500}.cdx-search-field__input:-ms-input-placeholder{color:#707684;font-weight:500}.cdx-search-field__input::-ms-input-placeholder{color:#707684;font-weight:500}.cdx-search-field__input::placeholder{color:#707684;font-weight:500}.ce-popover{--border-radius: 6px;--width: 200px;--max-height: 270px;--padding: 6px;--offset-from-target: 8px;--color-border: #e8e8eb;--color-shadow: rgba(13,20,33,.13);--color-background: white;--color-text-primary: black;--color-text-secondary: #707684;--color-border-icon: rgba(201, 201, 204, .48);--color-border-icon-disabled: #EFF0F1;--color-text-icon-active: #388AE5;--color-background-icon-active: rgba(56, 138, 229, .1);--color-background-item-focus: rgba(34, 186, 255, .08);--color-shadow-item-focus: rgba(7, 161, 227, .08);--color-background-item-hover: #eff2f5;--color-background-item-confirm: #E24A4A;--color-background-item-confirm-hover: #CE4343;min-width:var(--width);width:var(--width);max-height:var(--max-height);border-radius:var(--border-radius);overflow:hidden;-webkit-box-sizing:border-box;box-sizing:border-box;-webkit-box-shadow:0 3px 15px -3px var(--color-shadow);box-shadow:0 3px 15px -3px var(--color-shadow);position:absolute;left:0;top:calc(100% + var(--offset-from-target));background:var(--color-background);display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;z-index:4;opacity:0;max-height:0;pointer-events:none;padding:0;border:none}.ce-popover--opened{opacity:1;padding:var(--padding);max-height:var(--max-height);pointer-events:auto;-webkit-animation:panelShowing .1s ease;animation:panelShowing .1s ease;border:1px solid var(--color-border)}@media (max-width: 650px){.ce-popover--opened{-webkit-animation:panelShowingMobile .25s ease;animation:panelShowingMobile .25s ease}}.ce-popover__items{overflow-y:auto;-ms-scroll-chaining:none;overscroll-behavior:contain}@media (max-width: 650px){.ce-popover__overlay{position:fixed;top:0;bottom:0;left:0;right:0;background:#1d202b;z-index:3;opacity:.5;-webkit-transition:opacity .12s ease-in;transition:opacity .12s ease-in;will-change:opacity;visibility:visible}}.ce-popover__overlay--hidden{display:none}.ce-popover--open-top{top:calc(-1 * (var(--offset-from-target) + var(--popover-height)))}@media (max-width: 650px){.ce-popover{--offset: 5px;position:fixed;max-width:none;min-width:calc(100% - var(--offset) * 2);left:var(--offset);right:var(--offset);bottom:calc(var(--offset) + env(safe-area-inset-bottom));top:auto;border-radius:10px}.ce-popover .ce-popover__search{display:none}}.ce-popover__search,.ce-popover__custom-content:not(:empty){margin-bottom:5px}.ce-popover__nothing-found-message{color:#707684;display:none;cursor:default;padding:3px;font-size:14px;line-height:20px;font-weight:500;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.ce-popover__nothing-found-message--displayed{display:block}.ce-popover__custom-content:not(:empty){padding:4px}@media (min-width: 651px){.ce-popover__custom-content:not(:empty){padding:0}}.ce-popover__custom-content--hidden{display:none}.ce-popover-item{--border-radius: 6px;--icon-size: 20px;--icon-size-mobile: 28px;border-radius:var(--border-radius);display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;padding:3px;color:var(--color-text-primary);-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}@media (max-width: 650px){.ce-popover-item{padding:4px}}.ce-popover-item:not(:last-of-type){margin-bottom:1px}.ce-popover-item__icon{border-radius:5px;width:26px;height:26px;-webkit-box-shadow:0 0 0 1px var(--color-border-icon);box-shadow:0 0 0 1px var(--color-border-icon);background:#fff;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;margin-right:10px}.ce-popover-item__icon svg{width:20px;height:20px}@media (max-width: 650px){.ce-popover-item__icon{width:36px;height:36px;border-radius:8px}.ce-popover-item__icon svg{width:var(--icon-size-mobile);height:var(--icon-size-mobile)}}.ce-popover-item__title{font-size:14px;line-height:20px;font-weight:500;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}@media (max-width: 650px){.ce-popover-item__title{font-size:16px}}.ce-popover-item__secondary-title{color:var(--color-text-secondary);font-size:12px;margin-left:auto;white-space:nowrap;letter-spacing:-.1em;padding-right:5px;margin-bottom:-2px;opacity:.6}@media (max-width: 650px){.ce-popover-item__secondary-title{display:none}}.ce-popover-item--active{background:var(--color-background-icon-active);color:var(--color-text-icon-active)}.ce-popover-item--active .ce-popover-item__icon{-webkit-box-shadow:none;box-shadow:none}.ce-popover-item--disabled{color:var(--color-text-secondary);cursor:default;pointer-events:none}.ce-popover-item--disabled .ce-popover-item__icon{-webkit-box-shadow:0 0 0 1px var(--color-border-icon-disabled);box-shadow:0 0 0 1px var(--color-border-icon-disabled)}.ce-popover-item--focused:not(.ce-popover-item--no-focus){background:var(--color-background-item-focus)!important}.ce-popover-item--focused:not(.ce-popover-item--no-focus){-webkit-box-shadow:inset 0 0 0px 1px var(--color-shadow-item-focus);box-shadow:inset 0 0 0 1px var(--color-shadow-item-focus)}.ce-popover-item--hidden{display:none}@media (hover: hover){.ce-popover-item:hover{cursor:pointer}.ce-popover-item:hover:not(.ce-popover-item--no-hover){background-color:var(--color-background-item-hover)}.ce-popover-item:hover .ce-popover-item__icon{-webkit-box-shadow:none;box-shadow:none}}.ce-popover-item--confirmation{background:var(--color-background-item-confirm)}.ce-popover-item--confirmation .ce-popover-item__icon{color:var(--color-background-item-confirm)}.ce-popover-item--confirmation .ce-popover-item__title{color:#fff}@media (hover: hover){.ce-popover-item--confirmation:not(.ce-popover-item--no-hover):hover{background:var(--color-background-item-confirm-hover)}}.ce-popover-item--confirmation:not(.ce-popover-item--no-focus).ce-popover-item--focused{background:var(--color-background-item-confirm-hover)!important}.ce-popover-item--confirmation .ce-popover-item__icon,.ce-popover-item--active .ce-popover-item__icon,.ce-popover-item--focused .ce-popover-item__icon{-webkit-box-shadow:none;box-shadow:none}@-webkit-keyframes panelShowing{0%{opacity:0;-webkit-transform:translateY(-8px) scale(.9);transform:translateY(-8px) scale(.9)}70%{opacity:1;-webkit-transform:translateY(2px);transform:translateY(2px)}to{-webkit-transform:translateY(0);transform:translateY(0)}}@keyframes panelShowing{0%{opacity:0;-webkit-transform:translateY(-8px) scale(.9);transform:translateY(-8px) scale(.9)}70%{opacity:1;-webkit-transform:translateY(2px);transform:translateY(2px)}to{-webkit-transform:translateY(0);transform:translateY(0)}}@-webkit-keyframes panelShowingMobile{0%{opacity:0;-webkit-transform:translateY(14px) scale(.98);transform:translateY(14px) scale(.98)}70%{opacity:1;-webkit-transform:translateY(-4px);transform:translateY(-4px)}to{-webkit-transform:translateY(0);transform:translateY(0)}}@keyframes panelShowingMobile{0%{opacity:0;-webkit-transform:translateY(14px) scale(.98);transform:translateY(14px) scale(.98)}70%{opacity:1;-webkit-transform:translateY(-4px);transform:translateY(-4px)}to{-webkit-transform:translateY(0);transform:translateY(0)}}.wobble{-webkit-animation-name:wobble;animation-name:wobble;-webkit-animation-duration:.4s;animation-duration:.4s}@-webkit-keyframes wobble{0%{-webkit-transform:translate3d(0,0,0);transform:translateZ(0)}15%{-webkit-transform:translate3d(-9%,0,0);transform:translate3d(-9%,0,0)}30%{-webkit-transform:translate3d(9%,0,0);transform:translate3d(9%,0,0)}45%{-webkit-transform:translate3d(-4%,0,0);transform:translate3d(-4%,0,0)}60%{-webkit-transform:translate3d(4%,0,0);transform:translate3d(4%,0,0)}75%{-webkit-transform:translate3d(-1%,0,0);transform:translate3d(-1%,0,0)}to{-webkit-transform:translate3d(0,0,0);transform:translateZ(0)}}@keyframes wobble{0%{-webkit-transform:translate3d(0,0,0);transform:translateZ(0)}15%{-webkit-transform:translate3d(-9%,0,0);transform:translate3d(-9%,0,0)}30%{-webkit-transform:translate3d(9%,0,0);transform:translate3d(9%,0,0)}45%{-webkit-transform:translate3d(-4%,0,0);transform:translate3d(-4%,0,0)}60%{-webkit-transform:translate3d(4%,0,0);transform:translate3d(4%,0,0)}75%{-webkit-transform:translate3d(-1%,0,0);transform:translate3d(-1%,0,0)}to{-webkit-transform:translate3d(0,0,0);transform:translateZ(0)}}
`;
class fi extends C {
  constructor() {
   ...
   */
  checkIsMobile() {
    this.isMobile = window.innerWidth < qe;
  }
  /**
  ...
  backspacePressed(e) {
    ...
    if (o.anyBlockSelected && !v.isSelectionExists) {
  ...
  documentClicked(e) {
    if (!e.isTrusted)
      return;
    const t = e.target;
    this.nodes.holder.contains(t) || v.isAtEditor || (this.Editor.BlockManager.dropPointer(), this.Editor.Toolbar.close());
  ...
  redactorClicked(e) {
    ...
    if (d.isAnchor(t) && o) {
      ...
      const i = t.getAttribute("href"), n = jt(i);
      Ut(n);
      return;
    }
   ...
   */
  selectionChanged() {
    const { CrossBlockSelection: e, BlockSelection: t } = this.Editor, o = v.anchorElement;
    if (e.isCrossBlockSelectionStarted && t.anyBlockSelected && v.get().removeAllRanges(), !o) {
      v.range || this.Editor.InlineToolbar.close();
      return;
    }
...
class bi {
  ...
  set configuration(e) {
    ...
    z(e) ? this.config = {
      ...
      holder: e
    }, Ie(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = Xe.VERBOSE), At(this.config.logLevel), Ie(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
    const t = {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (X(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || !1, (o = this.config.i18n) != null && o.messages && Y.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
  }
  /**
